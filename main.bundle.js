...
module.exports = "\n<link rel=\"stylesheet\" href=\"https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css\">\n  <script src=\"https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js\"></script>\n  <script src=\"https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js\"></script>\n\n  <script>\n$(document).ready(function(){\n    $('[data-toggle=\"tooltip\"]').tooltip();\n});\n</script>\n<br/><div class =\"navbar\">\n\n<button  (click)=\"gototodoapp()\">TodoApp</button>\n<button class=\"btn btn-primary\" (click)=\"gotosendlist()\">Send your list</button>\n<button  (click)=\"gotohelp()\">Help</button>\n\n</div>\n    <div class =\"main\" >\n\n              <h4><label for=\"username\">Send list via phone</label></h4>\n              <h4><input [(ngModel)]=\"username\" type=\"text\" placeholder = \"Add phone number\" required/></h4>\n              <p style=\"color:red\">{{regUserNameSmall}}</p>\n\n            <button data-toggle=\"tooltip\" data-placement=\"top\" title=\"Click to send list by phone\" (click)=\"register()\">Send</button>\n<h4>or</h4>\n\n              <h4><label for=\"username\">Send list via email</label></h4>\n              <h4><input [(ngModel)]=\"email\" type=\"emial\" placeholder = \"Add email\" required/></h4>\n              <p style=\"color:red\">{{regValidEmail}}</p>\n\n              <button  data-toggle=\"tooltip\" data-placement=\"top\" title=\"Click to send list by email\" (click)=\"registeremail()\">Send</button>\n\n\n\n</div>\n\n<h4>You are now logged in..</h4>\n<button class=\"btn btn-primary\"(click)=\"logout()\"  title=\"Click to Logout\">Logout</button>\n"
...
module.exports = "<link rel=\"stylesheet\" href=\"https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css\">\n  <script src=\"https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js\"></script>\n  <script src=\"https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js\"></script>\n\n  <script>\n$(document).ready(function(){\n    $('[data-toggle=\"tooltip\"]').tooltip();\n});\n</script>\n\n<br/>\n<div class =\"navbar\">\n\n<button (click)=\"gototodoapp()\">TodoApp</button>\n<button (click)=\"gotosendlist()\">Send your list</button>\n<button class=\"btn btn-primary\" (click)=\"gotohelp()\">Help</button>\n</div>\n<div class =\"main\">\n\n  <h3>How to use application:</h3>\n  <p> - <b>To Add item</b> type task into \"Add item\" box and click \"ADD\" button</p>\n  <p>You will not be able to \"ADD\" if the input task is empty</p>\n  <p> - <b>To Edit item</b> click EDIT button on the right side of added task. Then, changed the text in \"Add item\" box and click \"ADD\" button</p>\n  <p> - <b>To Delete item</b> click DELETE button on the right side of added task to remove each item</p>\n  <p> - <b>To Mark item as completed</b> Click on &#9744; checkbox on the left side of each task to cross it off</p>\n  <p> - <b>To Forward the list</b> </p>\n    <p>Phone- type 10 digit number into \"Add phone number\" box and click SEND button</p>\n\n  <p>Email- type a valid email address into \"Add email\" box and click SEND button</p>\n\n<br/>\n</div>\n\n<h4>You are now logged in..</h4>\n<button class=\"btn btn-primary\"(click)=\"logout()\"  title=\"Click to Logout\">Logout</button>\n"
...
module.exports = "<link rel=\"stylesheet\" href=\"https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css\">\n  <script src=\"https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js\"></script>\n  <script src=\"https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js\"></script>\n\n  <script>\n$(document).ready(function(){\n    $('[data-toggle=\"tooltip\"]').tooltip();\n});\n</script>\n\n\n\n\n<div class =\"main\">\n\n  <input [(ngModel)]=\"todoText\" placeholder = \"Add Item\" required [(ngModel)]=\"newItem\"\n  input type=\"text\" ><button data-toggle=\"tooltip\" data-placement=\"top\" title=\"Click to add item to the list\" (click)=\"addTodo()\">ADD</button> <font style=\"color:red\">{{itemAddError}}</font>\n\n\n\n  <br>\n  <br>\n  <br>\n\n\n\n\n\n\n  <ul>\n    <li *ngFor = \"let task of todoadd; let i=index\">\n      <button data-toggle=\"tooltip\" data-placement=\"top\" title=\"Click to delete item\" id =\"update\"(click)=\"delete(i)\">Delete</button>\n      <button data-toggle=\"tooltip\" data-placement=\"top\" title=\"Click to edit item\"id =\"update\"(click)=\"edit(i)\">Edit</button>\n      <span class=\"check\" *ngIf=\"checkedIndices[i]==true\"> <s >{{task.text}}</s> </span>\n      <span class=\"check\" *ngIf=\"!(checkedIndices[i])==true\">{{task.text}}</span>\n      <input type =\"checkbox\"  (click)=\"checkBoxClicked(i)\" >\n\n\n\n\n    </li>\n    <br/>\n  </ul>\n</div>\n"
